...
c.N = c.N_e + c.N_i
c.N_u_e = int(np.floor(0.1*c.N_e))
c.N_u_i = 0

c.W_ee = utils.Bunch(lamb = 0.01*c.N_e,
...
c.eta_ip_o = 0.005
c.h_ip_e = 0.1
c.h_ip_o = np.array([0.05,0.4,0.05,0.05,0.4,0.05])
...
c.input_gain = 1
c.experiment.module = 'examples.experiment_RMTask'
